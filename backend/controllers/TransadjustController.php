...
use backend\models\TransadjustSearch;
 ...
 */
class TransadjustController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new TransadjustSearch();
...
\backend\Models\Transline::deleteAll(['transtableid'=>$id]);
    ...
    {
        if (($model = Transadjust::findOne($id)) !== null) {
            return $model;
        } else {
